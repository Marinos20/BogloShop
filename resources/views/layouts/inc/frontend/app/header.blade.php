                   ...
                   <div class="tp-header-top-right tp-header-top-black d-flex align-items-center justify-content-end">
                      <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                         <div class="tp-header-top-menu-item tp-header-lang">
                            <span class="tp-header-lang-toggle" id="tp-header-lang-toggle">Français</span>
                            <ul>
                               <li>
                                  <a href="#">Français</a>
                               </li>
                         ...
                         <div class="tp-header-top-menu-item tp-header-currency">
                            <span class="tp-header-currency-toggle" id="tp-header-currency-toggle">BJ</span>
                            <ul>
                               <li>
                                  <a href="#">BJ</a>
                               </li>
                         ...
                         <div class="tp-header-top-menu-item tp-header-setting">
                            <span class="tp-header-setting-toggle" id="tp-header-setting-toggle">Parametres</span>
                            <ul>
                                @guest
                                <li>
                               ...
                               <li>
                                  <a href="{{ url('/wishlist') }}">Liste de souhaits</a>
                               </li>
                               <li>
                                  <a href="{{ url('/cart') }}">Panier</a>
                               </li>
                               <li>
                                  <a style="cursor: pointer;" onclick="document.getElementById('logout').submit()">Déconnexion</a>
                               </li>
                         ...
                         <nav class="tp-main-menu-content">
                            <ul>
                                <li class="has-dropdown">
                                    <a href="{{ url('/collection') }}">Nos Collections</a>
                                    <ul class="tp-submenu">
                   ...
                   <div class="col-xl-5 col-lg-7 col-md-7 col-sm-8 col-6">
                      <div class="tp-header-bottom-right d-flex align-items-center justify-content-end pl-30">
                         ...
                         <div class="tp-header-action d-flex align-items-center ml-30">
                            ...
                            <div class="tp-header-action-item d-none d-lg-block">
                               <a href="{{ url('/wishlist') }}" class="tp-header-action-btn">
                                  ...
                                  <span class="tp-header-action-badge"><livewire:frontend.wishlist.wishlist-count /></span>
                               </a>
                            </div>
                            <div class="tp-header-action-item">
                                  ...
                                  <span class="tp-header-action-badge"><livewire:frontend.cart.cart-count /></span>
                               </button>
                            </div>
