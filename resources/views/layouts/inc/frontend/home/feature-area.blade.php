          ...
          <div class="row align-items-center">
             <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="tp-feature-item-2 d-flex align-items-start">
                   ...
                   <h3 class="tp-feature-title-2">Livraison rapide</h3>
<p>Livraison rapide sur tous les articles</p>
             ...
             <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="tp-feature-item-2 d-flex align-items-start">
                   ...
                   <div class="tp-feature-content-2">
                      <h3 class="tp-feature-title-2">Retour & Remboursement</h3>
             ...
             <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="tp-feature-item-2 d-flex align-items-start">
                   ...
                   <div class="tp-feature-content-2">
                      <h3 class="tp-feature-title-2">Réduction Membres</h3>
                      <p>Sur chaque commande supérieure à {{ number_format(50000, 2, ',') }} CFA </p>
