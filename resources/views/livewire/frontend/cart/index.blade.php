          ...
          <div class="col-xl-12 col-lg-12">
             <div class="tp-cart-list mb-25 mr-30">
                <table class="table">
                   <thead>
                     <tr>
                       <th class="tp-cart-header-product">Produit</th>
                       <th class="tp-cart-header-product">Nom</th>
                       <th class="tp-cart-header-price">Prix</th>
                       <th class="tp-cart-header-color">Couleur</th>
                       <th class="tp-cart-header-size">Taille</th>
             ...
             <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                <div class="tp-cart-checkout-wrapper">
                   ...
                   <div class="tp-cart-checkout-proceed">
                      <a href="{{ url('/checkout') }}" class="tp-cart-checkout-btn w-100">Procéder au paiement</a>
                   </div>
                </div>
             </div>
          </div>
