          ...
          <div class="col-xl-6 col-lg-8">
             <div class="tp-login-wrapper">
                <div class="tp-login-top text-center mb-30">
                   <h3 class="tp-login-title">Inscrivez-vous à la boutique spirituelle Boglo.</h3>
                   <p>Vous avez déjà un compte ?  <span><a href="{{ url('/login') }}">Se connecter</a></span></p>
                </div>
                ...
                <div class="tp-login-option">
                   <div class="tp-login-input-wrapper">
                      <div class="tp-login-input-box">
                         <div class="tp-login-input">
                            <input wire:model="name" id="name" type="text" placeholder="Boglo Bolanle" style="@error('name') border: 1px solid red @enderror">
                         </div>
                      ...
                      <div class="tp-login-input-box">
                         <div class="tp-login-input">
                            <input wire:model="email" id="email" type="email" placeholder="boglo@mail.com" class="@error('email') border: 1px solid red @enderror">
                         </div>
                         <div class="tp-login-input-title">
                      ...
                      <div class="tp-login-input-box">
                         <div class="tp-login-input">
                            <input wire:model="password" id="tp_password" type="password" placeholder="Min. 6 character" class="@error('password') border: 1px solid red @enderror">
                         </div>
                         ...
                         <div class="tp-login-input-title">
                            <label for="tp_password">Mot de passe</label>
                         </div>
                         @error('password')
                             <span class="text-sm text-danger">{{ $message }}</span>
                         @enderror
                   ...
                   <div class="tp-login-bottom">
                      <button wire:loading.remove wire:target="create" type="submit" class="tp-login-btn w-100">S'inscrire</button>
                      <button wire:loading wire:target="create" type="button" class="tp-login-btn w-100">Vérification des identifiants...</button>
                   </div>
                </div>
            </form>
             </div>
