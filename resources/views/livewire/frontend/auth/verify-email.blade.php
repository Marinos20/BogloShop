          ...
          <div class="col-xl-6 col-lg-8">
             <div class="tp-login-wrapper">
                <div class="tp-login-top text-center mb-30">
                   <h3 class="tp-login-title">Vérifiez votre adresse e-mail</h3>
                   <p>Vérifiez votre e-mail pour le lien de vérification.</p>
                </div>
                ...
                <div class="tp-login-option">
                   ...
                   <div class="tp-login-bottom mb-15">
                      <button wire:loading.remove wire:target="verification_notification" type="submit" class="tp-login-btn w-100">Renvoyer le lien</button>
                      <button wire:loading wire:target="verification_notification" type="submit" class="tp-login-btn w-100">Envoi en cours...</button>
                   </div>
                </div>
                </form>
             </div>
