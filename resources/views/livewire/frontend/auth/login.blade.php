             ...
             <div class="tp-login-wrapper">
                ...
                <div class="tp-login-option">
                   <div class="tp-login-input-wrapper">
                      <div class="tp-login-input-box">
                         <div class="tp-login-input">
                            <input id="email" wire:model="email" type="email" placeholder="bogloShop@mail.com">
                         </div>
                      ...
                      <div class="tp-login-input-box">
                         <div class="tp-login-input">
                            <input id="tp_password" wire:model="password" type="password" placeholder="Min. 6 character">
                         </div>
                   ...
                   <div class="tp-login-bottom">
                      ...
                      <button wire:loading wire:target="store" type="submit" class="tp-login-btn w-100">Vérification des identifiants...</button>
                   </div>
                </div>
            </form>
             </div>
