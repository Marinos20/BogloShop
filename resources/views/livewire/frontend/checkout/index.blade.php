<section class="tp-checkout-area pb-120" data-bg-color="#EFF1F5" style="background-color: rgb(239, 241, 245);">
    ...
    <div class=" text-center ">
        ...
        <p>Votre panier est vide pour procéder au paiement.</p>
                ...
                <div class="col-xl-7 col-lg-7">
                    <div class="tp-checkout-verify">
                        <div class="tp-checkout-verify-item">
                            <p class="tp-checkout-verify-reveal">Client déjà inscrit ?
                                <button type="button" wire:click="login"
                                    class="tp-checkout-login-form-reveal-btn">
                                    <span wire:loading.remove wire:target="login">Cliquez ici pour vous connecter</span>
                                    <span wire:loading wire:target="login">Redirection vers la page de connexion
                                    </span>
                                </button></p>
                        </div>
                    </div>
                        ...
                        <div class="tp-checkout-verify-item">
                            <p class="tp-checkout-verify-reveal">Nouveau client ?
                                <button type="button" wire:click="register"
                                    class="tp-checkout-login-form-reveal-btn">
                                    <span wire:loading.remove wire:target="register">Cliquez ici pour vous inscrire</span>
                                    <span wire:loading wire:target="register">Redirection vers la page d’inscription</span>
                                </button></p>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="tp-checkout-input">
                                            ...
                                            <input type="text" placeholder="Nom complet" wire:model="full_name">
                                            @error('full_name')
                                    ...
                                    <div class="col-md-12">
                                        <div class="tp-checkout-input">
                                            ...
                                            <input type="tel" placeholder="Numero" wire:model="phone">
                                            @error('phone')
                                                <span class="text-sm text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="tp-checkout-input">
                                            ...
                                            <input type="email" placeholder="boglo@gmail.com" wire:model="email">
                                            @error('email')
                                                <span class="text-sm text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="tp-checkout-input">
                                            ...
                                            <input type="text" placeholder="Numéro de maison et nom de la rue"
                                    ...
                                    <div class="tp-checkout-verify-item">
                                        <p class="tp-checkout-verify-reveal"> <input type="checkbox" wire:model="shipping_address" id="shipping_address" class="tp-checkout-login-form-reveal-btn"><label class="tp-checkout-login-form-reveal-btn" for="">Livrer à une autre adresse</label></p>
                                        ...
                                        <div id="tpReturnCustomerLoginForm" class="tp-return-customer" style="display: none;">
                                            ...
                                            <div class="col-md-6">
                                                <div class="tp-checkout-input">
                                                    <label>Nom complet <span>*</span></label>
                                                    <input type="text" placeholder="Nom complet" wire:model="shipping_full_name">
                ...
                <div class="tp-checkout-place white-bg">
                    ...
                    <div class="tp-checkout-payment">
                        <div class="tp-checkout-payment-item">
                            ...
                            <div class="tp-checkout-payment-desc cheque-payment">
                                <p>Effectuez votre paiement directement sur notre compte bancaire. Veuillez utiliser votre numéro de commande comme référence de paiement. Votre commande ne sera expédiée qu'après réception des fonds sur notre compte.</p>
                            </div>
                        </div>
                        <div class="tp-checkout-payment-item">
                    ...
                    <div class="tp-checkout-agree">
                        <div class="tp-checkout-option">
                            ...
                            <label for="read_all">J'ai lu et j'accepte les conditions du site.</label>
                        </div>
                        @error('terms')
                    ...
                    <div class="tp-checkout-btn-wrapper">
                        ...
                        <button wire:loading wire:target="{{ url('/payment') }}" type="submit" class="tp-checkout-btn w-100">Redirection en cours</button>
                    </div>
                </div>
                </form>
            </div>
